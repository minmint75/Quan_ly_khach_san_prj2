...
public class CustomerController {
    ...
    // === VIEW DETAIL ===
    @GetMapping("/{id}")
    public String viewCustomer(@PathVariable String id, Model model, RedirectAttributes redirectAttributes) {
    ...
    @GetMapping("/api/{id}")
    @ResponseBody
    public Customer getCustomerApi(@PathVariable String id) {
