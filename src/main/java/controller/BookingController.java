...
public class BookingController {
    ...
    // === VIEW DETAIL ===
    @GetMapping("/{id}")
    public String viewBooking(@PathVariable String id, Model model, RedirectAttributes redirectAttributes) {
    ...
    @GetMapping("/api/{id}")
    @ResponseBody
    public Booking getBookingApi(@PathVariable String id) {
    ...
    public String addBooking(@ModelAttribute BookingRequest bookingRequest,
        ...
        log.info("Xử lý thêm booking mới: {}", bookingRequest);
